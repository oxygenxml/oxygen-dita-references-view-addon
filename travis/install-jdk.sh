...
#
# Site: https://github.com/sormuras/bach/blob/master/install-jdk.sh
# License: MIT License (https://github.com/sormuras/bach/blob/main/LICENSE)
#
...
function determine_url() {
    local properties='install-jdk.properties'
    url=$(${properties} | grep -i "${feature}-${os}=" | awk -F "=" '{print $2}')
