...
public class CustomWorkspaceAccessPluginExtension implements WorkspaceAccessPluginExtension {
	 ...
	 */
	JTree referencesTree = new JTree();
		...
		pluginWorkspaceAccess.addViewComponentCustomizer(new ViewComponentCustomizer() {
			...
			public void customizeView(ViewInfo viewInfo) {
				...
				"SampleWorkspaceAccessID".equals(viewInfo.getViewID())) {
					customMessagesArea = new JTextArea("Ref tree: ");
					viewInfo.setComponent(new JScrollPane(customMessagesArea));
					viewInfo.setTitle("DITA Outgoing References");
					referencesTree.setModel(null);
					LOGGER.info("tree " + referencesTree.getHeight());
